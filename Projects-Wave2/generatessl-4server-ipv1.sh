...
FUSION01=10.164.64.6
FUSION02=10.164.64.7
FUSION03=10.154.64.6
FUSION04=10.154.64.7
...
printf '\n\n===  %s  ==============================\n' $FUSION01
keytool   -list -keystore $KEYSTORE -storepass changeit -alias $FUSION01
printf '\n\n===  %s  ==============================\n' $FUSION02
keytool   -list -keystore $KEYSTORE -storepass changeit -alias $FUSION02
printf '\n\n===  %s  ==============================\n' $FUSION03
keytool   -list -keystore $KEYSTORE -storepass changeit -alias $FUSION03
printf '\n\n===  %s  ==============================\n' $FUSION04
keytool   -list -keystore $KEYSTORE -storepass changeit -alias $FUSION04
