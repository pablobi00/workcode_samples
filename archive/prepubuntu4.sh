...
# prepubuntu.sh v4.0 2021.02.24
# Added pip3 and docker-compose, cleaned ram/net; controls & commands for Ubuntu
...
apt -y install mlocate unzip nmon python3-pip iftop
