...
USERNOWHOME='/home/azureuser'
USERNOWNAME='azureuser'

# Upgrade OS

yum -y update
yum -y install ntp mlocate unzip wget tmux iftop
...
# wget https://<storage_account>.blob.core.windows.net/transfer001/jdk-8u291-linux-x64.rpm
